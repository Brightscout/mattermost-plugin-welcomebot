    ...
    return function (dispatch, getState) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            ...
            dispatch({
                ...
                meta: {
                    offline: {
                        effect: function () { return client_1.Client4.deletePreferences(userId, preferences); },
                        commit: {
                            type: action_types_1.PreferenceTypes.DELETED_PREFERENCES,
                        },
                        rollback: {
    ...
    return function (dispatch) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            dispatch({
                ...
                meta: {
                    offline: {
                        effect: function () { return client_1.Client4.savePreferences(userId, preferences); },
                        commit: {
                            type: action_types_1.PreferenceTypes.RECEIVED_PREFERENCES,
                        },
                        rollback: {
...
function deleteTeamSpecificThemes() {
    var _this = this;
    return function (dispatch, getState) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var state, getCategory, themePreferences, currentUserId, toDelete;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    state = getState();
                    getCategory = preferences_1.makeGetCategory();
                    themePreferences = getCategory(state, constants_1.Preferences.CATEGORY_THEME);
                    currentUserId = users_1.getCurrentUserId(state);
