...
export declare function getCustomEmojisByName(names: Array<string>): ActionFunc;
...
export declare function loadProfilesForCustomEmojis(emojis: Array<CustomEmoji>): ActionFunc;
