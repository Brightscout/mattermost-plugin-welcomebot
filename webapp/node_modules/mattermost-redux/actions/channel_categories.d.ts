...
export declare function moveCategory(teamId: string, categoryId: string, newIndex: number): (dispatch: DispatchFunc, getState: GetStateFunc) => Promise<{
    error: any;
    data?: undefined;
} | {
    data: string[];
...
export declare function createCategory(teamId: string, displayName: string, channelIds?: $ID<Channel>[]): ActionFunc;
