...
export declare function searchIfNeeded(searchText: string): (dispatch: DispatchFunc, getState: GetStateFunc) => Promise<import("../types/actions").ActionResult> | Promise<void>;
export declare function searchIfNeededInitial(searchText: string): (dispatch: DispatchFunc, getState: GetStateFunc) => Promise<import("../types/actions").ActionResult> | Promise<void>;
...
export declare function requestCategoriesListIfNeeded({ count, }?: {
    count: undefined;
}): (dispatch: DispatchFunc, getState: GetStateFunc) => Promise<import("../types/actions").ActionResult> | Promise<void>;
