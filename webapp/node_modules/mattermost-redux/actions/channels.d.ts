...
export declare function createGroupChannel(userIds: Array<string>): ActionFunc;
...
export declare function markChannelAsUnread(teamId: string, channelId: string, mentions: Array<string>): ActionFunc;
export declare function getChannelMembersByIds(channelId: string, userIds: Array<string>): ActionFunc;
...
export declare function membersMinusGroupMembers(channelID: string, groupIDs: Array<string>, page?: number, perPage?: number): ActionFunc;
export declare function getChannelModerations(channelId: string): ActionFunc;
export declare function patchChannelModerations(channelId: string, patch: Array<ChannelModerationPatch>): ActionFunc;
