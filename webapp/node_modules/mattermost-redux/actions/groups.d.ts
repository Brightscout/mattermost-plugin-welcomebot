...
export declare function getGroupsAssociatedToChannel(channelID: string, q: string | undefined, page: number | undefined, perPage: number | undefined, filterAllowReference: false): ActionFunc;
