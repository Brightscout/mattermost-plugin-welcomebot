        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    preferences_2.savePreferences(userId, preferences)(dispatch);
                    dispatch(actions_1.batchActions([
                        {
...
function markGroupChannelOpen(channelId) {
    ...
    return function (dispatch, getState) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            ...
            return [2 /*return*/, dispatch(preferences_2.savePreferences(currentUserId, preferences))];
        });
    }); };
}
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    storeMember = channels_1.getMyChannelMember(getState(), created.id);
            ...
            switch (_a.label) {
                ...
                case 4:
                    ...
                    if (channelId === currentChannelId && !viewArchivedChannels) {
                        ...
                        channelsInTeam = channels_1.getChannelsNameMapInTeam(state, teamId);
                        channel = channel_utils_1.getChannelByName(channelsInTeam, channels_1.getRedirectChannelNameForTeam(state, teamId));
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    prevChanManuallyUnread = channels_1.isManuallyUnread(getState(), prevChannelId);
                    if (viewTime < new Date().getTime() - (3 * 60 * 60 * 1000)) {
                        ...
                        preferences_2.savePreferences(currentUserId, preferences)(dispatch);
                    }
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 4:
                    ...
                    member = myMembers[channelId];
                    if (member) {
                        if (channels_1.isManuallyUnread(getState(), channelId)) {
                            actions.push({
...
function markChannelAsViewed(channelId, prevChannelId) {
    ...
    return function (dispatch, getState) {
        ...
        if (member) {
            ...
            if (channels_1.isManuallyUnread(state, channelId)) {
                actions.push({
                    type: action_types_1.ChannelTypes.REMOVE_MANUALLY_UNREAD,
                    data: { channelId: channelId },
                });
        ...
        if (prevMember && !channels_1.isManuallyUnread(getState(), prevChannelId)) {
            actions.push({
                type: action_types_1.ChannelTypes.RECEIVED_MY_CHANNEL_MEMBER,
...
function markChannelAsRead(channelId, prevChannelId, updateLastViewedAt) {
    ...
    return function (dispatch, getState) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_b) {
            ...
            if (channel && channels_1.isManuallyUnread(getState(), channelId)) {
                actions.push({
                    type: action_types_1.ChannelTypes.REMOVE_MANUALLY_UNREAD,
                    data: { channelId: channelId },
                });
            ...
            actions = [{
                    ...
                    data: {
                        ...
                        onlyMentions: myMembers[channelId] && myMembers[channelId].notify_props &&
                            myMembers[channelId].notify_props.mark_unread === constants_1.General.MENTION,
                    },
                }];
...
function favoriteChannel(channelId, updateCategories) {
    ...
    return function (dispatch, getState) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var state, currentUserId, preference, channel, category;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    state = getState();
                    ...
                    if (!preferences_1.getNewSidebarPreference(state)) return [3 /*break*/, 3];
                    if (!updateCategories) return [3 /*break*/, 2];
                    channel = channels_1.getChannel(state, channelId);
                ...
                return [2 /*return*/, dispatch(preferences_2.savePreferences(currentUserId, [preference]))];
            }
        });
    }); };
}
    ...
    return function (dispatch, getState) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [2 /*return*/, dispatch(preferences_2.deletePreferences(currentUserId, [preference]))];
            }
        });
    }); };
}
