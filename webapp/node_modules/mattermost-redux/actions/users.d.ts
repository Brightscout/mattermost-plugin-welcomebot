...
export declare function getMissingProfilesByIds(userIds: Array<string>): ActionFunc;
export declare function getMissingProfilesByUsernames(usernames: Array<string>): ActionFunc;
export declare function getProfilesByIds(userIds: Array<string>, options?: any): ActionFunc;
export declare function getProfilesByUsernames(usernames: Array<string>): ActionFunc;
...
export declare function getProfilesInChannel(channelId: string, page: number, perPage?: number, sort?: string): ActionFunc;
export declare function getProfilesInGroupChannels(channelsIds: Array<string>): ActionFunc;
...
export declare function getStatusesByIds(userIds: Array<string>): ActionFunc;
