...
function createPost(post, files) {
    ...
    return function (dispatch, getState) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            ...
            dispatch({
                type: action_types_1.PostTypes.RECEIVED_NEW_POST,
                data: tslib_1.__assign({ id: pendingPostId }, newPost),
                meta: {
                    offline: {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    dispatch(receivedNewPost(tslib_1.__assign({ id: pendingPostId }, newPost)));
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 3:
                    ...
                    dispatch(actions_1.batchActions([
                        ...
                        removePost(tslib_1.__assign({ id: pendingPostId }, newPost)),
...
exports.getUnreadPostData = getUnreadPostData;
...
function getPosts(channelId, page, perPage, fetchThreads) {
    var _this = this;
    ...
    return function (dispatch, getState) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, client_1.Client4.getPosts(channelId, page, perPage, fetchThreads)];
                case 1:
                    posts = _a.sent();
                    getProfilesAndStatusesForPosts(posts.posts, dispatch, getState);
                    return [3 /*break*/, 3];
...
function getPostsUnread(channelId, fetchThreads) {
    var _this = this;
    if (fetchThreads === void 0) { fetchThreads = true; }
    return function (dispatch, getState) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, client_1.Client4.getPostsUnread(channelId, userId, client_1.DEFAULT_LIMIT_BEFORE, client_1.DEFAULT_LIMIT_AFTER, fetchThreads)];
                case 2:
                    posts = _a.sent();
                    getProfilesAndStatusesForPosts(posts.posts, dispatch, getState);
                    return [3 /*break*/, 4];
...
function getPostsSince(channelId, since, fetchThreads) {
    var _this = this;
    if (fetchThreads === void 0) { fetchThreads = true; }
    return function (dispatch, getState) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var posts, error_12;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, client_1.Client4.getPostsSince(channelId, since, fetchThreads)];
                case 1:
                    posts = _a.sent();
                    getProfilesAndStatusesForPosts(posts.posts, dispatch, getState);
                    return [3 /*break*/, 3];
...
function getPostsBefore(channelId, postId, page, perPage, fetchThreads) {
    var _this = this;
    if (page === void 0) { page = 0; }
    if (perPage === void 0) { perPage = constants_1.Posts.POST_CHUNK_SIZE; }
    if (fetchThreads === void 0) { fetchThreads = true; }
    return function (dispatch, getState) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, client_1.Client4.getPostsBefore(channelId, postId, page, perPage, fetchThreads)];
                case 1:
                    posts = _a.sent();
                    getProfilesAndStatusesForPosts(posts.posts, dispatch, getState);
                    return [3 /*break*/, 3];
...
function getPostsAfter(channelId, postId, page, perPage, fetchThreads) {
    var _this = this;
    if (page === void 0) { page = 0; }
    if (perPage === void 0) { perPage = constants_1.Posts.POST_CHUNK_SIZE; }
    if (fetchThreads === void 0) { fetchThreads = true; }
    return function (dispatch, getState) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, client_1.Client4.getPostsAfter(channelId, postId, page, perPage, fetchThreads)];
                case 1:
                    posts = _a.sent();
                    getProfilesAndStatusesForPosts(posts.posts, dispatch, getState);
                    return [3 /*break*/, 3];
...
function getPostsAround(channelId, postId, perPage, fetchThreads) {
    var _this = this;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all([
                            client_1.Client4.getPostsAfter(channelId, postId, 0, perPage, fetchThreads),
                            client_1.Client4.getPostThread(postId, fetchThreads),
                            client_1.Client4.getPostsBefore(channelId, postId, 0, perPage, fetchThreads),
                        ])];
                case 1:
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    myChannelMember = channels_1.getMyChannelMember(state, post.channel_id);
                    websocketMessageProps = msg.data;
                    if (!(myChannelMember && Object.keys(myChannelMember).length === 0 && myChannelMember.constructor === 'Object')) return [3 /*break*/, 2];
                    return [4 /*yield*/, dispatch(channels_2.getMyChannelMember(post.channel_id))];
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2:
                    dispatch(completePostReceive(post, websocketMessageProps));
                    if (msg.data.channel_type === constants_1.General.DM_CHANNEL) {
                        otherUserId = channel_utils_1.getUserIdFromChannelName(currentUserId, msg.data.channel_name);
                        dispatch(preferences_1.makeDirectChannelVisibleIfNecessary(otherUserId));
                    }
                    else if (msg.data.channel_type === constants_1.General.GM_CHANNEL) {
                        dispatch(preferences_1.makeGroupMessageVisibleIfNecessary(post.channel_id));
                    }
                    return [2 /*return*/, { data: true }];
            }
        });
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, dispatch(actions_1.batchActions(actions))];
                case 1:
                    _a.sent();
                    if (post_utils_1.shouldIgnorePost(post)) {
                        return [2 /*return*/];
                    }
                    markAsRead = false;
                    markAsReadOnServer = false;
                    if (!channels_1.isManuallyUnread(getState(), post.channel_id)) {
                        if (post.user_id === users_1.getCurrentUserId(state) &&
                            !post_utils_1.isSystemMessage(post) &&
                            !post_utils_1.isFromWebhook(post)) {
                            markAsRead = true;
                            markAsReadOnServer = false;
                        }
                        else if (post.channel_id === channels_1.getCurrentChannelId(state)) {
                            markAsRead = true;
                            markAsReadOnServer = true;
                        }
                    }
                    if (!markAsRead) return [3 /*break*/, 4];
                    return [4 /*yield*/, dispatch(channels_2.markChannelAsRead(post.channel_id, undefined, markAsReadOnServer))];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, dispatch(channels_2.markChannelAsViewed(post.channel_id))];
                case 3:
                    _a.sent();
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, dispatch(channels_2.markChannelAsUnread(websocketMessageProps.team_id, post.channel_id, websocketMessageProps.mentions))];
                case 5:
                    _a.sent();
                    _a.label = 6;
...
exports.lastPostActions = lastPostActions;
