...
import { Command, CommandResponse, DialogSubmission, IncomingWebhook, OAuthApp, OutgoingWebhook, SubmitDialogResponse } from "../types/integrations";
...
import { Post, PostList, PostSearchResults } from "../types/posts";
...
import { GetTeamMembersOpts, Team, TeamInviteWithError, TeamMembership, TeamMemberWithError, TeamStats, TeamsWithCount, TeamUnread } from "../types/teams";
import { TermsOfService } from "../types/terms_of_service";
import { AuthChangeResponse, UserAccessToken, UserProfile, UsersStats, UserStatus, GetFilteredUsersStatsOpts } from "../types/users";
...
export default class Client4 {
    ...
    getTeams: (page?: number, perPage?: number, includeTotalCount?: boolean) => Promise<TeamsWithCount | Team[]>;
    searchTeams: (term: string, page?: number | undefined, perPage?: number | undefined) => Promise<TeamsWithCount | Team[]>;
    ...
    searchAllChannels: (term: string, opts?: ChannelSearchOpts) => Promise<ChannelsWithTotalCount | Channel[]>;
    ...
    getPostThread: (postId: string, fetchThreads?: boolean) => Promise<PostList>;
    getPosts: (channelId: string, page?: number, perPage?: number, fetchThreads?: boolean) => Promise<PostList>;
    getPostsUnread: (channelId: string, userId: string, limitAfter?: number, limitBefore?: number, fetchThreads?: boolean) => Promise<PostList>;
    getPostsSince: (channelId: string, since: number, fetchThreads?: boolean) => Promise<PostList>;
    getPostsBefore: (channelId: string, postId: string, page?: number, perPage?: number, fetchThreads?: boolean) => Promise<PostList>;
    getPostsAfter: (channelId: string, postId: string, page?: number, perPage?: number, fetchThreads?: boolean) => Promise<PostList>;
    ...
    getCommandAutocompleteSuggestionsList: (userInput: string, teamId: string, commandArgs: {}) => Promise<AutocompleteSuggestion[]>;
    ...
    executeCommand: (command: Command, commandArgs?: {}) => Promise<CommandResponse>;
    ...
    createComplianceReport: (job: Job) => Promise<Compliance>;
