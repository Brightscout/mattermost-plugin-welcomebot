...
export declare function makePreparePostIdsForPostList(): (state: types.store.GlobalState, options: PostFilterOptions) => string[];
...
export declare function combineUserActivitySystemPost(systemPosts?: Array<types.posts.Post>): {
    allUserIds: string[];
    allUsernames: string[];
    messageData: any[];
} | null;
