...
export declare function getChannelsIdForTeam(state: GlobalState, teamId: string): Array<string>;
export declare function getGroupDisplayNameFromUserIds(userIds: Array<string>, profiles: IDMappedObjects<UserProfile>, currentUserId: string, teammateNameDisplay: string): string;
...
export declare function filterChannelsMatchingTerm(channels: Array<Channel>, term: string): Array<Channel>;
