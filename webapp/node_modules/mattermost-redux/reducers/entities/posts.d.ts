...
export declare function openGraph(state: RelationOneToOne<Post, any> | undefined, action: GenericAction): any;
export declare function expandedURLs(state: Dictionary<string> | undefined, action: GenericAction): Dictionary<string>;
export default function (state: Partial<PostsState> | undefined, action: GenericAction): Partial<PostsState> | {
    posts: any;
    postsReplies: {
        [x: string]: number;
    };
