...
export declare const getListableTeamIds: (state: GlobalState) => $ID<Team>[];
...
export declare const getJoinableTeamIds: (state: GlobalState) => $ID<Team>[];
...
export declare const getMySortedTeamIds: (state: GlobalState, locale: string) => $ID<Team>[];
