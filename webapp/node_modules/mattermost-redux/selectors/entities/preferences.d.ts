...
export declare const getVisibleTeammate: (state: GlobalState) => $ID<UserProfile>[];
...
export declare const getTheme: (state: GlobalState) => any;
export declare function makeGetStyleFromTheme<Style>(): (state: GlobalState, getStyleFromTheme: (theme: any) => Style) => Style;
...
export declare const getNewSidebarPreference: (state: GlobalState) => boolean;
