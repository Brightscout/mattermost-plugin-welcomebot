...
export declare function filterChannels(unreadIds: Array<string>, favoriteIds: Array<string>, channelIds: Array<string>, unreadsAtTop: boolean, favoritesAtTop: boolean): Array<string>;
export declare function makeGetChannel(): (state: GlobalState, props: {
    id: string;
}) => Channel;
export declare const getChannel: (state: GlobalState, id: string) => Channel;
...
export declare const getChannelSetInCurrentTeam: (state: GlobalState) => Array<string>;
export declare const getChannelsInCurrentTeam: (state: GlobalState) => Array<Channel>;
...
export declare const getAllDirectChannels: (state: GlobalState) => Array<Channel>;
export declare const getAllDirectChannelsNameMapInCurrentTeam: (state: GlobalState) => NameMappedObjects<Channel>;
export declare const getGroupChannels: (state: GlobalState) => Array<Channel>;
export declare const getMyChannels: (state: GlobalState) => Array<Channel>;
export declare const getOtherChannels: (state: GlobalState, archived?: boolean | null) => Array<Channel>;
...
export declare const getAllDirectChannelIds: (state: GlobalState) => Array<string>;
export declare const getChannelIdsInCurrentTeam: (state: GlobalState) => Array<string>;
export declare const getChannelIdsForCurrentTeam: (state: GlobalState) => Array<string>;
export declare const getUnreadChannelIds: (state: GlobalState, lastUnreadChannel?: Channel | null) => Array<string>;
export declare const getUnreadChannels: (state: GlobalState, lastUnreadChannel?: Channel | null) => Array<Channel>;
export declare const getMapAndSortedUnreadChannelIds: (state: GlobalState, lastUnreadChannel: Channel, sorting: SortingType) => Array<string>;
export declare const getSortedUnreadChannelIds: (state: GlobalState, lastUnreadChannel: Channel | null, unreadsAtTop: boolean, favoritesAtTop: boolean, sorting: SortingType) => Array<string>;
export declare const getFavoriteChannels: (state: GlobalState) => Array<Channel>;
export declare const getFavoriteChannelIds: (state: GlobalState, lastUnreadChannel: Channel, unreadsAtTop: boolean, favoritesAtTop: boolean, sorting: SortingType) => Array<string>;
export declare const getSortedFavoriteChannelIds: (state: GlobalState, lastUnreadChannel: Channel | null, favoritesAtTop: boolean, unreadsAtTop: boolean, sorting: SortingType) => Array<string>;
export declare const getPublicChannels: (state: GlobalState) => Array<Channel>;
export declare const getPublicChannelIds: (state: GlobalState, lastUnreadChannel: Channel, unreadsAtTop: boolean, favoritesAtTop: boolean, sorting: SortingType) => Array<string>;
export declare const getSortedPublicChannelIds: (state: GlobalState, lastUnreadChannel: Channel | null, unreadsAtTop: boolean, favoritesAtTop: boolean, sorting: SortingType) => Array<string>;
export declare const getPrivateChannels: (a: GlobalState) => Array<Channel>;
export declare const getPrivateChannelIds: (state: GlobalState, lastUnreadChannel: Channel, unreadsAtTop: boolean, favoritesAtTop: boolean, sorting: SortingType) => Array<string>;
export declare const getSortedPrivateChannelIds: (state: GlobalState, lastUnreadChannel: Channel | null, unreadsAtTop: boolean, favoritesAtTop: boolean, sorting: SortingType) => Array<string>;
export declare const getDirectChannels: (state: GlobalState) => Array<Channel>;
export declare const getDirectAndGroupChannels: (a: GlobalState) => Array<Channel>;
export declare const getDirectChannelIds: (state: GlobalState, lastUnreadChannel: Channel, unreadsAtTop: boolean, favoritesAtTop: boolean, sorting: SortingType) => Array<string>;
...
export declare const getAllChannelIds: (state: GlobalState, lastUnreadChannel: Channel, unreadsAtTop: boolean, favoritesAtTop: boolean, sorting: SortingType) => Array<string>;
export declare const getAllSortedChannelIds: (state: GlobalState, lastUnreadChannel: Channel | null, unreadsAtTop: boolean, favoritesAtTop: boolean, sorting: SortingType) => Array<string>;
...
export declare function getChannelModerations(state: GlobalState, channelId: string): Array<ChannelModeration>;
