...
export declare function getCustomEmojis(state: GlobalState): IDMappedObjects<CustomEmoji>;
...
export declare const getCustomEmojiIdsSortedByName: (state: GlobalState) => Array<string>;
