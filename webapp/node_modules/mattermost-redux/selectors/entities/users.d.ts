...
export declare function getUserSessions(state: GlobalState): Array<any>;
export declare function getUserAudits(state: GlobalState): Array<any>;
...
export declare const getCurrentUserRoles: (state: GlobalState) => UserProfile['roles'];
export declare type UserMentionKey = {
    key: string;
    caseSensitive?: boolean;
};
export declare const getCurrentUserMentionKeys: (state: GlobalState) => Array<UserMentionKey>;
...
export declare const getProfiles: (state: GlobalState, filters: Filters) => Array<UserProfile>;
...
export declare const getProfilesInCurrentChannel: (state: GlobalState) => Array<UserProfile>;
export declare const getProfilesNotInCurrentChannel: (state: GlobalState) => Array<UserProfile>;
export declare const getProfilesInCurrentTeam: (state: GlobalState) => Array<UserProfile>;
export declare const getProfilesInTeam: (state: GlobalState, teamId: $ID<Team>, filters?: Filters) => Array<UserProfile>;
export declare const getProfilesNotInTeam: (state: GlobalState, teamId: $ID<Team>, filters?: Filters) => Array<UserProfile>;
export declare const getProfilesNotInCurrentTeam: (state: GlobalState) => Array<UserProfile>;
export declare const getProfilesWithoutTeam: (state: GlobalState, filters?: Filters) => Array<UserProfile>;
...
export declare function searchProfiles(state: GlobalState, term: string, skipCurrent?: boolean, filters?: Filters): Array<UserProfile>;
export declare function makeSearchProfilesInChannel(): (state: GlobalState, channelId: string, term: string, skipCurrent?: boolean, filters?: Filters | undefined) => UserProfile[];
export declare function searchProfilesInCurrentChannel(state: GlobalState, term: string, skipCurrent?: boolean): Array<UserProfile>;
export declare function searchProfilesNotInCurrentChannel(state: GlobalState, term: string, skipCurrent?: boolean): Array<UserProfile>;
export declare function searchProfilesInCurrentTeam(state: GlobalState, term: string, skipCurrent?: boolean): Array<UserProfile>;
export declare function searchProfilesInTeam(state: GlobalState, teamId: $ID<Team>, term: string, skipCurrent?: boolean, filters?: Filters): Array<UserProfile>;
export declare function searchProfilesNotInCurrentTeam(state: GlobalState, term: string, skipCurrent?: boolean): Array<UserProfile>;
export declare function searchProfilesWithoutTeam(state: GlobalState, term: string, skipCurrent?: boolean, filters?: Filters): Array<UserProfile>;
export declare const shouldShowTermsOfService: (state: GlobalState) => boolean;
export declare const getUsersInVisibleDMs: (state: GlobalState) => Array<UserProfile>;
export declare function makeGetProfilesForReactions(): (state: GlobalState, reactions: Array<Reaction>) => Array<UserProfile>;
export declare function makeGetProfilesInChannel(): (state: GlobalState, channelId: $ID<Channel>, filters?: Filters) => Array<UserProfile>;
export declare function makeGetProfilesNotInChannel(): (state: GlobalState, channelId: $ID<Channel>, filters?: Filters) => Array<UserProfile>;
...
export declare const getProfilesInGroup: (state: GlobalState, groupId: $ID<Group>, filters?: Filters) => Array<UserProfile>;
export declare function searchProfilesInGroup(state: GlobalState, groupId: $ID<Group>, term: string, skipCurrent?: boolean, filters?: Filters): Array<UserProfile>;
