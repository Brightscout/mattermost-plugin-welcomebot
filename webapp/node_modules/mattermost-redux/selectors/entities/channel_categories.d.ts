...
export declare function makeFilterAutoclosedDMs(getAutocloseCutoff?: typeof getDefaultAutocloseCutoff): (state: GlobalState, channels: Channel[], categoryType: string) => Channel[];
