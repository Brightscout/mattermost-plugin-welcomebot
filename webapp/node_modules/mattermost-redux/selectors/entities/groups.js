...
exports.getGroupsNotAssociatedToChannel = reselect_1.createSelector(getAllGroups, function (state, channelID) { return getChannelGroupIDSet(state, channelID); }, function (state, _, teamID) { return teams_1.getTeam(state, teamID); }, function (state, _, teamID) { return exports.getGroupsAssociatedToTeam(state, teamID); }, function (allGroups, channelGroupIDSet, team, teamGroups) {
