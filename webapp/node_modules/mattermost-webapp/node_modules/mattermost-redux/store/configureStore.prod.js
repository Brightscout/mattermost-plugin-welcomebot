...
function configureOfflineServiceStore(preloadedState, appReducer, userOfflineConfig, getAppReducer, clientOptions = {}) {
  const baseState = Object.assign({}, _initial_state.default, preloadedState);
  const baseOfflineConfig = Object.assign({}, _defaults.default, _helpers.offlineConfig, userOfflineConfig);
  const store = (0, _redux.createStore)((0, _reduxOffline.createOfflineReducer)((0, _helpers.createReducer)(baseState, _reducers.default, appReducer)), baseState, (0, _reduxOffline.offlineCompose)(baseOfflineConfig)((0, _middleware.createMiddleware)(clientOptions), []));

  _reducer_registry.default.setChangeListener(reducers => {
