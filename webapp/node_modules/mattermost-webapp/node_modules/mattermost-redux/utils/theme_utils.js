...
function changeOpacity(oldColor
/*: string*/
, opacity
/*: number*/
)
/*: string*/
{
  ...
  return "rgba(".concat(red, ",").concat(green, ",").concat(blue, ",").concat(alpha * opacity, ")");
}

function blendComponent(background
/*: number*/
, foreground
/*: number*/
, opacity
...
function blendColors(background
/*: string*/
, foreground
/*: string*/
, opacity
