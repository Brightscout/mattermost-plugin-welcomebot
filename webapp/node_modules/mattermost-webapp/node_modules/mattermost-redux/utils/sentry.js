...
function cleanUrlForLogging(baseUrl
/*: string*/
, apiUrl
/*: string*/
)
/*: string*/
{
  let url = apiUrl; // Trim the host name

  url = url.substring(baseUrl.length); // Filter the query string
